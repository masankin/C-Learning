...
namespace cocostudio
{
    ...
    Node* ButtonReader::createNodeWithFlatBuffers(const flatbuffers::Table *buttonOptions)
    {
		...
		std::string logStr = "";
		logStr.append("<AbstractNodeData Name=\"");
		logStr.append(button->getName() + "\"");
		logStr.append(" ActionTag=\"");
		logStr.append(ConvertToString(button->getActionTag()) + "\"");
		if (button->getCallbackType().compare("") != 0)
		{
			logStr.append(" CallBackType=\"");
			logStr.append(button->getCallbackType() + "\"");
			logStr.append(" CallBackName=\"");
			logStr.append(button->getCallbackName() + "\"");
		}
		logStr.append(" Tag=\"");
		logStr.append(ConvertToString(button->getTag()) + "\"");
		logStr.append(" Alpha=\"");
		logStr.append(ConvertToString((int)button->getOpacity()) + "\"");
		logStr.append(" VisibleForFrame=\"");
		logStr.append((button->isVisible() ? "True\"" : "False\""));
		logStr.append(" IconVisible=\"False\"");
		logStr.append(" TouchEnable=\"");
		logStr.append((button->isTouchEnabled() ? "True\"" : "False\""));
		logStr.append(" FlipX=\"");
		logStr.append((button->isFlippedX() ? "True\"" : "False\""));
		logStr.append(" FlipY=\"");
		logStr.append((button->isFlippedY() ? "True\"" : "False\""));
		logStr.append(" ButtonText=\"");
		logStr.append(button->getTitleText() + "\"");
		logStr.append(" FontSize=\"");
		logStr.append(ConvertToString(button->getTitleFontSize()) + "\"");
		logStr.append(" DisplayState=\"");
		logStr.append((button->isBright() ? "True\"" : "False\""));
		logStr.append(" ctype=\"ButtonObjectData\">\n");

		logStr.append("<TextColor ");
		logStr.append(" A=\"");
		logStr.append(ConvertToString(255) + "\"");
		logStr.append(" R=\"");
		logStr.append(ConvertToString((int)button->getTitleColor().r) + "\"");
		logStr.append(" G=\"");
		logStr.append(ConvertToString((int)button->getTitleColor().g) + "\"");
		logStr.append(" B=\"");
		logStr.append(ConvertToString((int)button->getTitleColor().b) + "\"/>\n");

		logStr.append("<FontResource ");
		logStr.append(" Type=\"Normal\"");
		logStr.append(" Path=\"");
		logStr.append(button->getTitleFontName() + "\"");
		logStr.append(" Plist=\"\"/>\n");

		logStr.append("<DisabledFileData ");
		logStr.append(" Type=\"Default\"");
		logStr.append(" Path=\"");
		logStr.append(disabledTexturePath + "\"");
		logStr.append(" Plist=\"\"/>\n");

		logStr.append("<PressedFileData ");
		logStr.append(" Type=\"Default\"");
		logStr.append(" Path=\"");
		logStr.append(pressedTexturePath + "\"");
		logStr.append(" Plist=\"\"/>\n");

		logStr.append("<NormalFileData ");
		logStr.append(" Type=\"Normal\"");
		logStr.append(" Path=\"");
		logStr.append(normalTexturePath + "\"");
		logStr.append(" Plist=\"\"/>\n");
