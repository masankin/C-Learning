...
//            }
    ...
    Node* CheckBoxReader::createNodeWithFlatBuffers(const flatbuffers::Table *checkBoxOptions)
    {
		...
		logStr.append(checkBox->getName() + "\"");
		logStr.append(" ActionTag=\"");
		logStr.append(ConvertToString(checkBox->getActionTag()) + "\"");
		if (checkBox->getCallbackType().compare("") != 0)
		{
			logStr.append(" CallBackType=\"");
			logStr.append(checkBox->getCallbackType() + "\"");
			logStr.append(" CallBackName=\"");
			logStr.append(checkBox->getCallbackName() + "\"");
		}
		logStr.append(" Tag=\"");
		logStr.append(ConvertToString(checkBox->getTag()) + "\"");
		logStr.append(" Alpha=\"");
		logStr.append(ConvertToString((int)checkBox->getOpacity()) + "\"");
		logStr.append(" VisibleForFrame=\"");
		logStr.append((checkBox->isVisible() ? "True\"" : "False\""));
		logStr.append(" IconVisible=\"False\"");
		logStr.append(" TouchEnable=\"");
		logStr.append((checkBox->isTouchEnabled() ? "True\"" : "False\""));
		logStr.append(" FlipX=\"");
		logStr.append((checkBox->isFlippedX() ? "True\"" : "False\""));
		logStr.append(" FlipY=\"");
		logStr.append((checkBox->isFlippedY() ? "True\"" : "False\""));
		logStr.append(" CheckedState=\"");
		logStr.append((checkBox->isSelected() ? "True\"" : "False\""));
		logStr.append(" ctype=\"CheckBoxObjectData\">\n");
		//

		logStr.append("<NormalBackFileData ");
		logStr.append(" Type=\"Normal\"");
		logStr.append(" Path=\"");
		logStr.append(backGroundTexturePath + "\"");
		logStr.append(" Plist=\"\"/>\n");

		logStr.append("<PressedBackFileData ");
		logStr.append(" Type=\"Normal\"");
		logStr.append(" Path=\"");
		logStr.append(backGroundSelectedTexturePath + "\"");
		logStr.append(" Plist=\"\"/>\n");

		logStr.append("<DisableBackFileData ");
		logStr.append(" Type=\"Normal\"");
		logStr.append(" Path=\"");
		logStr.append(frontCrossDisabledFileName + "\"");
		logStr.append(" Plist=\"\"/>\n");
