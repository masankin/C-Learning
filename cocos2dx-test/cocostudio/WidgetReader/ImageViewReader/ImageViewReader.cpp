...
namespace cocostudio
{
    ...
    Node* ImageViewReader::createNodeWithFlatBuffers(const flatbuffers::Table *imageViewOptions)
    {
		...
		logStr.append(imageView->getName() + "\"");
		logStr.append(" ActionTag=\"");
		logStr.append(ConvertToString(imageView->getActionTag()) + "\"");
		if (imageView->getCallbackType().compare("") != 0)
		{
			logStr.append(" CallBackType=\"");
			logStr.append(imageView->getCallbackType() + "\"");
			logStr.append(" CallBackName=\"");
			logStr.append(imageView->getCallbackName() + "\"");
		}
		logStr.append(" Tag=\"");
		logStr.append(ConvertToString(imageView->getTag()) + "\"");
		logStr.append(" Alpha=\"");
		logStr.append(ConvertToString((int)imageView->getOpacity()) + "\"");
		logStr.append(" VisibleForFrame=\"");
		logStr.append((imageView->isVisible() ? "True\"" : "False\""));
		logStr.append(" IconVisible=\"False\"");
		logStr.append(" TouchEnable=\"");
		logStr.append((imageView->isTouchEnabled() ? "True\"" : "False\""));
		logStr.append(" FlipX=\"");
		logStr.append((imageView->isFlippedX() ? "True\"" : "False\""));
		logStr.append(" FlipY=\"");
		logStr.append((imageView->isFlippedY() ? "True\"" : "False\""));
		logStr.append(" ctype=\"ImageViewObjectData\">\n");

		logStr.append("<FileData ");
