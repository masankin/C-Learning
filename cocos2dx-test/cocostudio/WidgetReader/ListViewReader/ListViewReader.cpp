...
namespace cocostudio
{
    ...
    Node* ListViewReader::createNodeWithFlatBuffers(const flatbuffers::Table *listViewOptions)
    {
		...
		logStr.append(listView->getName() + "\"");
		logStr.append(" ActionTag=\"");
		logStr.append(ConvertToString(listView->getActionTag()) + "\"");
		if (listView->getCallbackType().compare("") != 0)
		{
			logStr.append(" CallBackType=\"");
			logStr.append(listView->getCallbackType() + "\"");
			logStr.append(" CallBackName=\"");
			logStr.append(listView->getCallbackName() + "\"");
		}
		logStr.append(" Tag=\"");
		logStr.append(ConvertToString(listView->getTag()) + "\"");
		logStr.append(" Alpha=\"");
		logStr.append(ConvertToString((int)listView->getOpacity()) + "\"");
		logStr.append(" VisibleForFrame=\"");
		logStr.append((listView->isVisible() ? "True\"" : "False\""));
		logStr.append(" IconVisible=\"False\"");
		logStr.append(" TouchEnable=\"");
		logStr.append((listView->isTouchEnabled() ? "True\"" : "False\""));
		logStr.append(" FlipX=\"");
		logStr.append((listView->isFlippedX() ? "True\"" : "False\""));
		logStr.append(" FlipY=\"");
		logStr.append((listView->isFlippedY() ? "True\"" : "False\""));
		logStr.append(" DirectionType=\"");
		...
		logStr.append(ConvertToString(0) + "\"");
		logStr.append(" ClipAble=\"");
		logStr.append((listView->isClippingEnabled() ? "True\"" : "False\""));
		logStr.append(" ctype=\"ListViewObjectData\">\n");
		//
