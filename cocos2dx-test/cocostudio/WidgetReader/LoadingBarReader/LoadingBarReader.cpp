...
namespace cocostudio
{
    ...
    Node* LoadingBarReader::createNodeWithFlatBuffers(const flatbuffers::Table *loadingBarOptions)
    {
		...
		logStr.append(loadingBar->getName() + "\"");
		logStr.append(" ActionTag=\"");
		logStr.append(ConvertToString(loadingBar->getActionTag()) + "\"");
		if (loadingBar->getCallbackType().compare("") != 0)
		{
			logStr.append(" CallBackType=\"");
			logStr.append(loadingBar->getCallbackType() + "\"");
			logStr.append(" CallBackName=\"");
			logStr.append(loadingBar->getCallbackName() + "\"");
		}
		logStr.append(" Tag=\"");
		logStr.append(ConvertToString(loadingBar->getTag()) + "\"");
		logStr.append(" Alpha=\"");
		logStr.append(ConvertToString((int)loadingBar->getOpacity()) + "\"");
		logStr.append(" VisibleForFrame=\"");
		logStr.append((loadingBar->isVisible() ? "True\"" : "False\""));
		logStr.append(" IconVisible=\"False\"");
		logStr.append(" TouchEnable=\"");
		logStr.append((loadingBar->isTouchEnabled() ? "True\"" : "False\""));
		logStr.append(" FlipX=\"");
		logStr.append((loadingBar->isFlippedX() ? "True\"" : "False\""));
		logStr.append(" FlipY=\"");
		logStr.append((loadingBar->isFlippedY() ? "True\"" : "False\""));
		logStr.append(" ctype=\"LoadingBarObjectData\">\n");
		//

		logStr.append("<ImageFileData ");
