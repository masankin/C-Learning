...
namespace cocostudio
{
    ...
    Node* ScrollViewReader::createNodeWithFlatBuffers(const flatbuffers::Table *scrollViewOptions)
    {
		...
		logStr.append(scrollView->getName() + "\"");
		logStr.append(" ActionTag=\"");
		logStr.append(ConvertToString(scrollView->getActionTag()) + "\"");
		if (scrollView->getCallbackType().compare("") != 0)
		{
			logStr.append(" CallBackType=\"");
			logStr.append(scrollView->getCallbackType() + "\"");
			logStr.append(" CallBackName=\"");
			logStr.append(scrollView->getCallbackName() + "\"");
		}
		logStr.append(" Tag=\"");
		logStr.append(ConvertToString(scrollView->getTag()) + "\"");
		logStr.append(" Alpha=\"");
		logStr.append(ConvertToString((int)scrollView->getOpacity()) + "\"");
		logStr.append(" VisibleForFrame=\"");
		logStr.append((scrollView->isVisible() ? "True\"" : "False\""));
		logStr.append(" IconVisible=\"False\"");
		logStr.append(" TouchEnable=\"");
		logStr.append((scrollView->isTouchEnabled() ? "True\"" : "False\""));
		logStr.append(" FlipX=\"");
		logStr.append((scrollView->isFlippedX() ? "True\"" : "False\""));
		logStr.append(" FlipY=\"");
		logStr.append((scrollView->isFlippedY() ? "True\"" : "False\""));
		logStr.append(" ComboBoxIndex=\"");
		logStr.append("1\"");
		logStr.append(" BackColorAlpha=\"");
		logStr.append(" 102\"");
		logStr.append(" ColorAngle=\"");
		logStr.append(ConvertToString(90) + "\"");
		logStr.append(" ScrollDirectionType=\"");
		logStr.append("Vertical\"");
		logStr.append(" ClipAble=\"");
		logStr.append((scrollView->isClippingEnabled() ? "True\"" : "False\""));
		logStr.append(" ctype=\"ScrollViewObjectData\">\n");

		logStr.append("<InnerNodeSize ");
		logStr.append(" Width=\"");
		logStr.append(ConvertToString(scrollView->getInnerContainerSize().width) + "\"");
		logStr.append("	Height=\"");
		logStr.append(ConvertToString(scrollView->getInnerContainerSize().height) + "\"/>\n");
		log("%s", logStr.c_str());
        return scrollView;
    }
