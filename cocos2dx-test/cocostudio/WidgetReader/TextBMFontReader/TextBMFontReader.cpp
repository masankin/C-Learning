...
namespace cocostudio
{
    ...
    Node* TextBMFontReader::createNodeWithFlatBuffers(const flatbuffers::Table *textBMFontOptions)
    {
		...
		logStr.append(textBMFont->getName() + "\"");
		logStr.append(" ActionTag=\"");
		logStr.append(ConvertToString(textBMFont->getActionTag()) + "\"");
		if (textBMFont->getCallbackType().compare("") != 0)
		{
			logStr.append(" CallBackType=\"");
			logStr.append(textBMFont->getCallbackType() + "\"");
			logStr.append(" CallBackName=\"");
			logStr.append(textBMFont->getCallbackName() + "\"");
		}
		logStr.append(" Tag=\"");
		logStr.append(ConvertToString(textBMFont->getTag()) + "\"");
		logStr.append(" Alpha=\"");
		logStr.append(ConvertToString((int)textBMFont->getOpacity()) + "\"");
		logStr.append(" VisibleForFrame=\"");
		logStr.append((textBMFont->isVisible() ? "True\"" : "False\""));
		logStr.append(" IconVisible=\"False\"");
		logStr.append(" TouchEnable=\"");
		logStr.append((textBMFont->isTouchEnabled() ? "True\"" : "False\""));
		logStr.append(" FlipX=\"");
		logStr.append((textBMFont->isFlippedX() ? "True\"" : "False\""));
		logStr.append(" FlipY=\"");
		logStr.append((textBMFont->isFlippedY() ? "True\"" : "False\""));
		logStr.append(" LabelText=\"");
		logStr.append(text + "\"");
		logStr.append(" ctype=\"TextBMFontObjectData\">\n");
		//

		logStr.append("<LabelBMFontFile_CNB ");
