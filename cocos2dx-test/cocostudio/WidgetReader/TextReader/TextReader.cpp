...
namespace cocostudio
{
    ...
    Node* TextReader::createNodeWithFlatBuffers(const flatbuffers::Table *textOptions)
    {
		...
		logStr.append(text->getName() + "\"");
		logStr.append(" ActionTag=\"");
		logStr.append(ConvertToString(text->getActionTag()) + "\"");
		if (text->getCallbackType().compare("") != 0)
		{
			logStr.append(" CallBackType=\"");
			logStr.append(text->getCallbackType() + "\"");
			logStr.append(" CallBackName=\"");
			logStr.append(text->getCallbackName() + "\"");
		}
		logStr.append(" Tag=\"");
		logStr.append(ConvertToString(text->getTag()) + "\"");
		logStr.append(" Alpha=\"");
		logStr.append(ConvertToString((int)text->getOpacity()) + "\"");
		logStr.append(" VisibleForFrame=\"");
		logStr.append((text->isVisible() ? "True\"" : "False\""));
		logStr.append(" IconVisible=\"False\"");
		logStr.append(" TouchEnable=\"");
		logStr.append((text->isTouchEnabled() ? "True\"" : "False\""));
		logStr.append(" FlipX=\"");
		logStr.append((text->isFlippedX() ? "True\"" : "False\""));
		logStr.append(" FlipY=\"");
		logStr.append((text->isFlippedY() ? "True\"" : "False\""));
		logStr.append(" LabelText=\"");
		logStr.append(text->getString() + "\"");
		logStr.append(" FontSize=\"");
		logStr.append(ConvertToString(text->getFontSize()) + "\"");
		logStr.append(" ctype=\"TextObjectData\">\n");
		//
		...
		logStr.append(" Path=\"");
		logStr.append(text->getFontName() + "\"");
		logStr.append(" Plist=\"\"/>\n");
